...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(primaryColor: Colors.white, brightness: Brightness.light),
      home: Scaffold(
        appBar: AppBar(
          title: const Text(
            "Je t'aime bb, Denilson",
            style: TextStyle(
            ...
            child: Row(
              ...
              children: [
                Text(
                  text,
                  style: TextStyle(
                      color: colors, fontSize: 30, fontWeight: FontWeight.bold),
                  textAlign: TextAlign.right,
                ),
