              ...
              children: [
                ...
                Container(
                  ...
                  child: Wrap(
                    ...
                    runSpacing: 6.0,
                    children: <Widget>[
                      boutons(operation[0], Colors.grey[400]!,largeur,
                          colors: Colors.black),
                      boutons(operation[1], Colors.grey[400]!,largeur,
                          colors: Colors.black),
                      boutons(operation[2], Colors.grey[400]!,largeur,
                          colors: Colors.black),
                      boutons(operation[3], Colors.orange[400]!,largeur),
                      boutons(operation[4], Colors.grey[800]!,largeur),
                      boutons(operation[5], Colors.grey[800]!,largeur),
                      boutons(operation[6], Colors.grey[800]!,largeur),
                      boutons(operation[7], Colors.orange[400]!,largeur),
                      boutons(operation[8], Colors.grey[800]!,largeur),
                      boutons(operation[9], Colors.grey[800]!,largeur),
                      boutons(operation[10], Colors.grey[800]!,largeur),
                      boutons(operation[11], Colors.orange[400]!,largeur),
                      boutons(operation[12], Colors.grey[800]!,largeur),
                      boutons(operation[13], Colors.grey[800]!,largeur),
                      boutons(operation[14], Colors.grey[800]!,largeur),
                      boutons(operation[15], Colors.orange[400]!,largeur),
                      boutons(operation[16], Colors.grey[800]!,largeur,
                          x: 85.0, y: 85.0, isWide: true),
                      boutons(operation[17], Colors.grey[800]!,largeur),
                      boutons(operation[18], Colors.orange[400]!,largeur),
                    ],
                  ),
                ),
              ],
        ...
        onTap: () {
          setState(() {
            if ((_controller.text.length < 15) &&
              ...
              _controller.text = numero = pourcent();
              if (numero == "error") {
                numero = "";
              }
            } else if (text == "-/+") {
